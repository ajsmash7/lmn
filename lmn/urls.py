...
urlpatterns = [
    ...
    path('notes/detail/<int:note_pk>/edit/', views_notes.edit_note_detail, name='edit_note_detail'),
    # path('notes/detail/<int:note_pk>/photo/', views_notes.note_photo, name='note_detail_photo'),
